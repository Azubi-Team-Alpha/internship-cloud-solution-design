...
<CardGrid stagger>
  ...
  <Card title="Outils et Équipements" icon="seti:eslint">
    Découvrez la gamme complète d'outils et d'équipements de qualité supérieure de AlphaPay. Chaque sous-section offre des spécifications détaillées, des instructions d'utilisation et des conseils de maintenance.
  </Card>
